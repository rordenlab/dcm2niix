...
#else
static const int kMaxDTI4D = 18000; //issue460: maximum number of DTI directions for 4D (Philips) images, also maximum number of 3D slices for Philips 3D and 4D images
#endif
