...
static const uint8_t MAX_NUMBER_OF_DIMENSIONS = 8;
    ...
    struct TDTI4D {
        ...
        float contentTime[kMaxDTI4D], frameReferenceTime[kMaxDTI4D], frameDuration[kMaxDTI4D], decayFactor[kMaxDTI4D], volumeOnsetTime[kMaxDTI4D], triggerDelayTime[kMaxDTI4D], TE[kMaxDTI4D], RWVScale[kMaxDTI4D], RWVIntercept[kMaxDTI4D], intenScale[kMaxDTI4D], intenIntercept[kMaxDTI4D], intenScalePhilips[kMaxDTI4D];
    ...
    struct TDICOMdata {
        ...
        float contentTime, frameReferenceTime, frameDuration, ecat_isotope_halflife, ecat_dosage;
